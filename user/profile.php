...
<head>
    ...
    <title>Resep Bunda - Profile saya</title>
        ...
        <div class="container">
            <div class="row mb-3 justify-content-center">
                <div class="col-7 bg-light shadow-sm p-4 rounded bg-white">
                    ...
                    <!-- profile saya -->
                    <form method="POST" action="functions/update-profile.php">   
                        <input type="hidden" name="id_profile" value="<?= $dataProfile['id_profile'] ?>">
                        <h2 class="float-left">Profil anda</h2> <br>
                        <div class="form-group">
                            <input type="text" class="form-control" name="nama_lengkap" value="<?= $dataProfile['nama_lengkap'] ?>" placeholder="Nama lengkap" required>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" name="no_hp" value="<?= $dataProfile['no_hp'] ?>" placeholder="Nomor HP" required>
                        </div>
                        <div class="form-group">
                            <textarea class="form-control" placeholder="Alamat" name="alamat" rows="3" required><?= $dataProfile['alamat'] ?></textarea>
                        </div>
                        <button type="submit" name="update_profile" style="width: 100%" class="btn btn-info">Update profile</button>
                    </form> <br><hr>
                    <!-- profile saya -->
